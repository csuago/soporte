...
public class entrada extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cuadro2.add(usuario);
        usuario.setBounds(10, 10, 86, 22);

        txtusuario.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        txtusuario.setText("elimar");
        ...
        clave.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        clave.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        clave.setText("Clave:");
        cuadro2.add(clave);
        clave.setBounds(10, 60, 62, 22);

        txtpswusr.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        txtpswusr.setText("tcqxngnw");
        ...
        btonaceptar.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        try {
            ...
            if (rs.next()) { // SI EL USUARIO EXISTE
                ...
                if (valor.equals("B")) {
                    ...
                    menu.conn1 = MiConexionBD.getMiConexion();
                    menu.sql = sql;
                    proceso.sql = sql;
                    limpiar();
                    rs.close();
